...
namespace MediaArchiveTool.Helpers.ExifLib
{
    /// <summary>
...
#pragma warning restore CS8605 // Unboxing a possibly null value.
        ...
        private ExifReader(Stream stream, bool leaveOpen, bool internalStream)
        {
            ...
            _ifd0PrimaryCatalogue = new Dictionary<ushort, long>();
            _ifdExifCatalogue = new Dictionary<ushort, long>();
            _ifdGPSCatalogue = new Dictionary<ushort, long>();
